// Plik konfiguracyjny (Baza danych) EduBox AI
// Jeśli dodajesz nową aplikację, po prostu dopisz tu nowy obiekt!

window.EduBoxData = {
    RECOMMENDATIONS: [
        { name: 'Chmurka AI', url: 'https://chmurka.ai/', icon: '☁️', desc: 'Obrazy, wideo, muzyka w jednym miejscu.' },
        { name: 'ChatGPT', url: 'https://chat.openai.com/', icon: '🤖', desc: 'Najpotężniejszy model językowy.' },
    ...
    APPS: [
        ...
        { title: 'Asystent Pedagoga (IPET/WWRD)', desc: 'Kombajn modułowy pedagoga specjalnego: kompletne IPET-y, WOPFU, opinie o funkcjonowaniu ucznia (ocena funkcjonalna) oraz pełna dokumentacja Wczesnego Wspomagania Rozwoju Dziecka (WWRD) - diagnozy, IPWW, scenariusze zajęć i ewaluacje, wspomagane przez AI.', url: 'asystent-pedagoga.html', badge: 'SPE + WWRD', badgeColor: 'bg-gradient-to-r from-rose-600 to-fuchsia-500', icon: 'ph-file-text', color: 'text-rose-500', category: 'biurokracja', tags: ['ipet', 'wopfu', 'ocena funkcjonalna', 'specjalna', 'wwrd', 'wczesne wspomaganie', 'ipww'], featured: true, verified2026: true },
        { title: 'Baza Druków', desc: 'Katalog wzorów dokumentów urzędowych (IPET, WOPFU i inne) z podziałem na urzędowe/proponowane oraz możliwością dodania własnych druków placówki.', url: 'edudruki.html', icon: 'ph-file-arrow-down', color: 'text-amber-500', category: 'biurokracja', tags: ['druki', 'wzory', 'ipet', 'wopfu', 'urzędowe', 'formularze'], verified2026: true },
        ...
        { title: 'EduPiktogram', desc: 'Kreator Planów Dnia AAC, gotowy do wydruku.', url: 'edupiktogram.html', icon: 'ph-image-square', color: 'text-emerald-500', category: 'terapia', tags: ['plan dnia', 'aac', 'piktogramy'] },

        // --- BIUROKRACJA I DOKUMENTY ---
        { title: 'EduOddech - Chwila dla Nauczyciela', desc: 'Krótkie, sprawdzone ćwiczenia oddechowe i relaksacyjne. 2, 5 albo 10 minut dla siebie między lekcjami.', url: 'eduoddech.html', badge: 'NOWOŚĆ', badgeColor: 'bg-teal-600', icon: 'ph-heart', color: 'text-teal-500', category: 'terapia', tags: ['dobrostan', 'stres', 'oddech', 'nauczyciel'] },
        { title: 'EduDyplom Wideo', desc: 'Animowany dyplom wideo dopasowany do okazji i wieku dziecka - unikalna grafika AI za każdym razem.', url: 'edudyplom.html', badge: 'NOWOŚĆ', badgeColor: 'bg-pink-600', icon: 'ph-confetti', color: 'text-pink-500', category: 'grafika', tags: ['dyplom', 'wideo', 'przedszkole', 'animacja'] },
        { title: 'EduPodsumowanie', desc: 'Efektowne wideo-podsumowanie dowolnego wydarzenia (rok, wycieczka, projekt, konkurs) w stylu "Wrapped" - z muzyką w tle, dopasowane do wieku dzieci.', url: 'edupodsumowanie.html', badge: 'NOWOŚĆ', badgeColor: 'bg-purple-600', icon: 'ph-film-strip', color: 'text-purple-400', category: 'grafika', tags: ['podsumowanie', 'wideo', 'wrapped', 'rok szkolny', 'wycieczka', 'projekt', 'konkurs', 'muzyka'] },
        { title: 'Asystent Wdrożenia Reformy 2026', desc: 'Sprawdź dokładnie, co zmienia się w Twojej klasie od 1 września 2026 r. i jak się przygotować.', url: 'edureforma.html', badge: 'NOWOŚĆ', badgeColor: 'bg-teal-600', icon: 'ph-compass', color: 'text-teal-500', category: 'biurokracja', tags: ['reforma', 'kompas jutra', 'podstawa programowa'] , verified2026: true },
        { title: 'Kreator Awansu AI', desc: 'Automatyczne sprawozdania i "Ocena Dorobku Zawodowego".', url: 'awans.html', badge: 'AWANS', badgeColor: 'bg-blue-600', icon: 'ph-briefcase', color: 'text-blue-500', category: 'biurokracja', tags: ['awans', 'dorobek', 'sprawozdanie'] , verified2026: true },
        ...
        { title: "EduPDF Edytor", desc: "Korektor i wypełniacz plików PDF. Zamazuj błędy, dodawaj własny tekst i twórz puste strony bez psucia oryginalnego układu.", url: "edupdf.html", badge: "NOWOŚĆ", badgeColor: "bg-blue-600", icon: "ph-file-pdf", color: "text-blue-500", category: "biurokracja", tags: ["pdf", "edytor", "dokumenty", "korektor", "wypełniacz"] },
        { title: "EduRaport AI", desc: "Automatyczny asystent sprawozdań. Zamienia luźne notatki z wycieczek, projektów i mentoringu w profesjonalne, wielostronicowe ewaluacje gotowe dla dyrekcji.",url: "eduraport.html",icon: "ph-check-square-offset",color: "text-emerald-500",category: "biurokracja",tags: ["sprawozdanie", "ewaluacja", "wycieczka", "mentor", "awans", "dokumenty"],badge: "NOWOŚĆ",badgeColor: "bg-red-500"},
        ...
        { title: 'Edukacja Obywatelska AI', desc: 'Debaty i symulacje pod Edukację Obywatelską i Zdrowotną.', url: 'edukacja2025.html?mode=civic', badge: 'ZAKTUALIZOWANE', badgeColor: 'bg-emerald-600', icon: 'ph-sparkle', color: 'text-emerald-500', category: 'zajecia', tags: ['obywatelska', 'zdrowotna', 'debaty'] , verified2026: true },
        ...
        { title: 'EduZastępstwo 999', desc: 'Nagłe zastępstwo? Baza kreatywnych gier słownych bez ksera (Zero-Prep).', url: 'eduzastepstwo.html', icon: 'ph-warning-circle', color: 'text-emerald-500', category: 'zajecia', tags: ['zastępstwo', 'gry', 'słowne'] },
        ...
        { title: 'EduWakacje PRO', desc: 'Zero-Prep dla wychowawców. Generuje plany półkolonii, gry terenowe i ratunkowe zabawy (SOS). Wspiera grupy SPE.', url: 'eduwakacje.html', badge: 'WAKACJE', badgeColor: 'bg-amber-500 text-amber-950', icon: 'ph-sun', color: 'text-amber-500', category: 'zajecia', tags: ['wakacje', 'kolonie', 'półkolonie', 'gry', 'zabawy', 'lato', 'spe'] },
        { title: "EduWystrój AI",desc: "Kreator całych pakietów dekoracyjnych. Generuje gazetki, kodeksy, dekoracje na drzwi i szyldy w perfekcyjnym formacie wektorowym do druku.",url: "edudekorator.html",icon: "ph-scissors",color: "text-emerald-600",category: "grafika",tags: ["dekoracje", "gazetki", "wystrój", "kodeks", "drzwi", "plakaty", "przedszkole"],badge: "HIT",badgeColor: "bg-red-500"},

        { title: 'EduKatalog (Generator Ofert)', desc: 'Automatycznie tworzy profesjonalną ofertę zajęć dodatkowych na bazie Twoich aplikacji EduBox.', url: 'edukatalog.html', badge: 'NOWOŚĆ', badgeColor: 'bg-emerald-600', icon: 'ph-briefcase', color: 'text-emerald-500', category: 'biurokracja', tags: ['oferta', 'katalog', 'marketing'] },

        // --- GRAFIKA I KREATYWNE ---
        { title: 'EduGenerator PRO', desc: 'Dyplomy z całym ozdobnym tłem malowanym przez AI (13 gotowych motywów okazji: Dzień Chłopaka, Mamy, Pasowanie...) plus ozdobne girlandy.', url: 'edugenerator.html', badge: 'PREMIUM', badgeColor: 'bg-indigo-600', icon: 'ph-certificate', color: 'text-indigo-500', category: 'grafika', tags: ['dyplomy', 'girlandy', 'dzień chłopaka', 'dzień mamy', 'pasowanie', 'motywy'] },
        { title: 'EduDyplomy AI', desc: 'Generator rymowanych dyplomów "z przymrużeniem oka" na koniec roku.', url: 'edudyplomy.html', badge: 'KONIEC ROKU', badgeColor: 'bg-rose-500', icon: 'ph-medal', color: 'text-rose-500', category: 'grafika', tags: ['dyplomy', 'wierszyki', 'zakończenie'] },
        { title: 'Magic Color AI', desc: 'Inteligentny rysownik. Wpisz dowolny pomysł, a AI narysuje go dla Twoich dzieci.', url: 'magiccolor.html', icon: 'ph-magic-wand', color: 'text-pink-500', category: 'grafika', tags: ['kolorowanki', 'rysunki', 'grafika'] },
        { title: 'EduPlakat AI', desc: 'Generator pięknych grafik i plakatów. Opisz scenę, a AI stworzy czystą ilustrację.', url: 'eduplakat.html', badge: 'NOWOŚĆ', badgeColor: 'bg-purple-600', icon: 'ph-image', color: 'text-purple-500', category: 'grafika', tags: ['plakat', 'ilustracja', 'grafika'] },
        { title: 'EduStudio AI', desc: 'Zaawansowane studio graficzne. Wybieraj oświetlenie, kadry i proporcje suwakami.', url: 'edustudio.html', badge: 'PRO', badgeColor: 'bg-indigo-600', icon: 'ph-sliders', color: 'text-indigo-500', category: 'grafika', tags: ['studio', 'grafika', 'kreator'] },
        { title: 'EduGazetka AI', desc: 'Generator wystroju klasy. Gigantyczne litery i 4 gotowe plakaty informacyjne (A4).', url: 'edugazetka.html', badge: 'HIT!', badgeColor: 'bg-teal-600', icon: 'ph-newspaper', color: 'text-teal-500', category: 'grafika', tags: ['gazetka', 'wystrój', 'plakaty'] },
        { title: 'EduBoxPro MagicLetters', desc: 'Profesjonalny generator girland ze wsparciem AI. Własne tła, kształty i tekstury.', url: 'magicletters.html', badge: 'NOWOŚĆ', badgeColor: 'bg-purple-600', icon: 'ph-text-aa', color: 'text-purple-500', category: 'grafika', tags: ['girlandy', 'litery', 'napisy'] },
        { title: 'Kreator Ikon PRO', desc: 'Zrób porządek na pulpicie. Konwertuje grafiki na profesjonalne pliki Windows .ICO.', url: 'https://kreator-ikon.vercel.app/', icon: 'ph-app-window', color: 'text-slate-400', category: 'grafika', tags: ['ikony', 'ico', 'pulpit'] },
        { title: "EduMalarz AI",desc: "Twój profesjonalny asystent graficzny. Generuje medale, ramki, zaproszenia i naklejki w formatach gotowych do wydruku.",url: "edumalarz.html",icon: "ph-palette",color: "text-pink-500",category: "grafika",tags: ["grafika", "medale", "zaproszenia", "naklejki", "rysunki", "dekoracje", "przedszkole"], badge: "PREMIUM",badgeColor: "bg-purple-600"},
        {  title: 'EduDetox AI', desc: 'Humorystyczny asystent wakacyjny. Wygeneruje dla Ciebie przezabawny autoresponder na Librusa i wystawi certyfikat za przetrwanie roku!',  url: 'edudetox.html',  badge: 'VIRAL', badgeColor: 'bg-teal-500 text-slate-900', icon: 'ph-plant', color: 'text-teal-400', category: 'zajecia', tags: ['wakacje', 'urlop', 'relaks', 'śmieszne', 'humor', 'detox'] }
    ]
};
