...
window.EduBoxData = {
    ...
    APPS: [
        ...
        { title: 'Asystent Pedagoga (IPET/WWRD)', desc: 'Tworzy kompletne IPET-y, WOPFU, opinie o funkcjonowaniu ucznia (ocena funkcjonalna) oraz pełną dokumentację Wczesnego Wspomagania Rozwoju Dziecka (WWRD): diagnozy, IPWW, scenariusze i ewaluacje.', url: 'asystent-pedagoga.html', badge: 'SPE', badgeColor: 'bg-rose-600', icon: 'ph-file-text', color: 'text-rose-500', category: 'biurokracja', tags: ['ipet', 'wopfu', 'ocena funkcjonalna', 'specjalna', 'wwrd', 'wczesne wspomaganie', 'ipww'] , verified2026: true },
