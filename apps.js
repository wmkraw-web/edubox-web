...
window.EduBoxData = {
    ...
    APPS: [
        ...
        { title: 'EduPodsumowanie', desc: 'Efektowne wideo-podsumowanie roku/semestru klasy w stylu "Wrapped". Podaj 3 fakty, AI zrobi resztę.', url: 'edupodsumowanie.html', badge: 'NOWOŚĆ', badgeColor: 'bg-purple-600', icon: 'ph-film-strip', color: 'text-purple-400', category: 'grafika', tags: ['podsumowanie', 'wideo', 'wrapped', 'rok szkolny', 'klasa'] },
