...
window.EduBoxData = {
    ...
    APPS: [
        ...
        // --- GRAFIKA I KREATYWNE ---
        { title: 'EduGenerator PRO', desc: 'Cudowne dyplomy dla klasy i ozdobne girlandy ze zintegrowanym wycinaniem tła.', url: 'edugenerator.html', badge: 'PREMIUM', badgeColor: 'bg-indigo-600', icon: 'ph-certificate', color: 'text-indigo-500', category: 'grafika', tags: ['dyplomy', 'girlandy'] },
