...
window.EduBoxData = {
    ...
    APPS: [
        ...
        { title: 'Asystent Pedagoga (IPET)', desc: 'Tworzy kompletne IPET-y, WOPFU i opinie o funkcjonowaniu ucznia (ocena funkcjonalna) w oparciu o prawo oświatowe.', url: 'asystent-pedagoga.html', badge: 'SPE', badgeColor: 'bg-rose-600', icon: 'ph-file-text', color: 'text-rose-500', category: 'biurokracja', tags: ['ipet', 'wopfu', 'ocena funkcjonalna', 'specjalna'] , verified2026: true },
